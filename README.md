...
-	**How each weather feature can affect energy consumption**:
   ...
   o	Precipitation and cloud coverage: Precipitation and cloud coverage will cool a building in the summer which can result in a decrease in energy consumption. During the winter, precipitation will make a building colder, which may lead to an increase in energy consumption.
...
Dummy Regressor	380	380		
Linear Regression	300	304	129	130
Ridge Regression	300	303	129	130
Random Forest Regression	78	186	30	79
